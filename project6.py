...
class Graph():
    ...
    class Vertex():
        ...
        def __init__(self, name, addr, type):
            ...
            self.msg_id = []    # store messages id to avoid receiving same message
...
def main():
    ...
    # find thw shortest path with dijkstra's algorithm
    def find_path():
    ...
    # find the shortest path with the maximium bandwidth
    def find_bw_path():
